...
<br>
	        ...
	        <h:panelGrid columns="2" id="panelGridInputs">
				...
				<h:inputText id="endereco" value="#{pessoaMB.pessoa.logradouro}" styleClass="edit" size="40" />
				...
				<h:inputText id="cep" value="#{pessoaMB.pessoa.cep}" styleClass="edit" size="9" maxlength="9" />
